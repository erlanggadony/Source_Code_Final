          ...
          <div class="row">
            <div class="col-md-8 content">
              ...
              <form class="form-horizontal" action="{{ url('/preview') }}" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                      <input type="text" class="form-control" name="namaAnggota3" placeholder="Nama anggota" required>
                    </div>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" name="npmAnggota3" placeholder="NPM" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                      <input type="text" class="form-control" name="namaAnggota4" placeholder="Nama anggota" required>
                    </div>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" name="npmAnggota4" placeholder="NPM" required>
                    </div>
                </div>
