            ...
            <div class="col-md-8 content form-horizontal">
              ...
              <form class="form-horizontal" action="{{ url('/preview') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-xs-2 col-sm-offset-3 ">
                      <input type="text" class="form-control" name="kodeMK10" placeholder="Kode" required>
                    </div>
                    <div class="col-xs-4">
                      <input type="text" class="form-control" name="matkul10" placeholder="Nama mata kuliah" required>
                    </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" name="sks10" placeholder="sks" required>
                      </div>
                  </div>
